...
void Debug_WBE_CreateWindow (WBE_Window window) {
    ...
    SDL_Log("%s Window Is Fullscreen: %s\n", WBE_NAME_Debug_CreateWindow, (window.isFullscreen == 1 ? "True" : "False"));
    SDL_Log("%s Window Is Borderless: %s\n", WBE_NAME_Debug_CreateWindow, (window.isBorderless == 1 ? "True" : "False"));
    SDL_Log("%s Window Is Hidden: %s\n", WBE_NAME_Debug_CreateWindow, (window.isHidden == 1 ? "True" : "False"));
    SDL_Log("%s Window Is Resizable: %s\n", WBE_NAME_Debug_CreateWindow, (window.isResizable == 1 ? "True" : "False"));
}